(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue-good-table'), require('pptxgenjs'), require('html2canvas')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vue-good-table', 'pptxgenjs', 'html2canvas'], factory) :
  (global = global || self, factory(global.ExtendedTable = {}, global.vueGoodTable, global.PptxGenJS, global.html2canvas));
}(this, function (exports, vueGoodTable, PptxGenJS, html2canvas) { 'use strict';

  PptxGenJS = PptxGenJS && PptxGenJS.hasOwnProperty('default') ? PptxGenJS['default'] : PptxGenJS;
  ...
  var script = {
    name: "ExtendedTable",
    components: {
      VueGoodTable: vueGoodTable.VueGoodTable
    },
    props: {
      tableData: {
        data: Object,
